...
class TestAirtableService(unittest.TestCase):
    ...
    @mock.patch('services.utils.fetch_data_github')
    @mock.patch('services.utils.save_data_github')
    @mock.patch('services.utils.datetime')
    @mock.patch('services.place_data_service.PlaceDataProviderFactory.get_provider')
    def test_caching_system(self, mock_get_provider, mock_datetime, mock_save_data_github, mock_fetch_data_github):
        ...
        with mock.patch('services.airtable_service.AirtableService.get_record') as mock_get_record, \
             mock.patch('services.utils._fill_photos_from_airtable') as mock_fill_photos:
        ...
        # Create stale cached data (older than refresh interval)
        ...
        with mock.patch('services.airtable_service.AirtableService.get_record') as mock_get_record, \
            ...
            mock_provider.get_all_place_data.return_value = {
                "place_id": place_id,
                "place_name": place_name,
                "details": {"website": "https://new-example.com"},
                "photos": {
            ...
            # Verify the results
            self.assertEqual(status, 'succeeded')
            self.assertEqual(data['details']['website'], "https://new-example.com")
        ...
        # Create fresh cached data (well within refresh interval)
        ...
        with mock.patch('services.airtable_service.AirtableService.get_record') as mock_get_record:
            ...
            self.assertEqual(data['details']['website'], "https://cached-example.com")
        ...
        # Use the same fresh cached data as before
        mock_fetch_data_github.return_value = (True, fresh_cached_data, "Success")
        ...
        with mock.patch('services.airtable_service.AirtableService.get_record') as mock_get_record, \
            ...
            # Verify the results
            self.assertEqual(status, 'succeeded')
            self.assertEqual(data['details']['website'], "https://force-refresh-example.com")
        ...
        with mock.patch('services.airtable_service.AirtableService.get_record') as mock_get_record, \
            ...
            # Verify the results
            self.assertEqual(status, 'succeeded')
            self.assertEqual(data['details']['website'], "https://photo-optimization-example.com")
